...
const models: TsoaRoute.Models = {
  ...
  UserListDTO: {
    ...
    type: {
      dataType: 'array',
      array: { dataType: 'refAlias', ref: 'UserDTO' },
      validators: {},
    },
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: Router) {
  ...
  app.post(
    ...
    async function UserController_addUser(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    async function UserController_fetchUserList(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    async function UserController_fetchUser(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.put(
    ...
    async function UserController_renewUser(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.delete(
    ...
    async function UserController_destroyUser(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
